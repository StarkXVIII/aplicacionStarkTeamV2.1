...
/*Clase Farmacia que corresponde a un objeto con los atributos de una farmacia requeridos para listarlos en la opción
* de farmacias de turno*/
public class Farmacia {

    /*Declaración de atributos de una farmacia presentes en la web del gobierno*/
    ...
    /*Funciones getter, setter y contructor de la clase Farmacia de cada uno de los atributos para su eventual extración o
